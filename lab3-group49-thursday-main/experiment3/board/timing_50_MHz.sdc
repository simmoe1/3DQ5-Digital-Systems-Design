...
set_input_delay -clock clk_50 -max 18 [all_inputs]
set_input_delay -clock clk_50 -min 12 [all_inputs]

# Constrain the output-to-register paths

set_output_delay -clock clk_50 -max 18 [all_outputs]
set_output_delay -clock clk_50 -min 12 [all_outputs]
